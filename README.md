...
## Process Parameters (From TSMC 180 nm Tech File)

* Threshold Voltage, V<sub>th</sub> = 0.366 V
* Oxide Thickness, T<sub>ox</sub> = 4.1 × 10<sup>-9</sup> m
* Electron Mobility, μ<sub>n</sub> = 273.809 × 10<sup>-4</sup> m²/V·s
